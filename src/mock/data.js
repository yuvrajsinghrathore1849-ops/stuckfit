...
export const reviews = [
  {
    ...
    author: 'Sarah M.',
    rating: 5,
    text: 'The quality of the linen trousers is outstanding. They drape beautifully and feel incredibly premium.',
    productInfo: 'Linen Blend Trousers'
  },
  {
    id: 'r2',
    author: 'James T.',
    rating: 5,
    text: 'Stuckfit has become my go-to for basics. The minimal aesthetic is exactly what I was looking for.',
    productInfo: 'Minimalist Cotton T-Shirt'
  },
  {
    id: 'r3',
    author: 'Emily K.',
    rating: 4,
    text: 'Gorgeous oversized coat. It runs slightly larger than expected, but the overall look is so chic.',
    productInfo: 'Oversized Wool Blend Coat'
  }
];
